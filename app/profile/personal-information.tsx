    ...
    <SafeAreaView style={tw`flex-1 pb-8 bg-[${LIGHT_GRAY}]`}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={tw`flex-1`}>
        ...
        <RefreshableScrollView style={tw`flex-1 px-3 pt-6`} showsVerticalScrollIndicator={false} contentContainerStyle={tw`pb-28`} refreshing={refreshing} onRefresh={onRefresh}>
          ...
          <View style={tw`bg-white rounded-2xl border border-gray-200 p-5 mb-6`}>
            <View style={tw`mb-5`}>
            ...
            <View style={tw`mb-5`}>
              ...
              <View style={[inputStyle(false), { height: 52 }]}>
          ...
          {editing && (
            <TouchableOpacity style={tw`bg-blue-600 py-4 rounded-2xl mb-6`} onPress={handleSave} disabled={loading} activeOpacity={0.8}>
          ...
          <View style={tw`bg-white border border-gray-200 p-4 rounded-xl`}>
            <View style={tw`flex-row items-center mb-2`}>
              ...
              <Text style={tw`text-gray-900 font-semibold ml-2`}>Verification Required</Text>
            </View>
