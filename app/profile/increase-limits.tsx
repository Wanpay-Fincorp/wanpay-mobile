  ...
  return (
    <SafeAreaView style={tw`flex-1 pb-8 bg-[${DARK_BG}]`}>
      ...
      <RefreshableScrollView style={tw`flex-1 px-3 pt-6`} showsVerticalScrollIndicator={false} contentContainerStyle={tw`pb-8`}>
        ...
        <View style={tw`mb-5`}>
          <Text style={tw`text-gray-600 text-[12px] font-semibold tracking-wide mb-2`}>Desired Daily Limit (₦)</Text>
        ...
        <View style={tw`mb-5`}>
          <Text style={tw`text-gray-600 text-[12px] font-semibold tracking-wide mb-2`}>Desired Monthly Limit (₦)</Text>
        ...
        <View style={tw`mb-5`}>
          <Text style={tw`text-gray-600 text-[12px] font-semibold tracking-wide mb-2`}>Desired Single Transaction Limit (₦)</Text>
        ...
        <View style={tw`mb-6`}>
          <Text style={tw`text-gray-600 text-[12px] font-semibold tracking-wide mb-2`}>Reason for Increase</Text>
          <View style={[tw`bg-gray-50 border ${errors.reason ? 'border-red-500/70' : 'border-gray-200'} rounded-2xl px-4 pt-4`, { minHeight: 120 }]}>
